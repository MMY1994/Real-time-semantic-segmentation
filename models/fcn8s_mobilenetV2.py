...
from models.encoders.mobilenet_V2 import MobileNet_V2
from layers.convolution import conv2d_transpose, conv2d, atrous_conv2d

import tensorflow as tf


class FCN8sMobileNet_V2(BasicModel):
    """
    FCN8s with MobileNet_V2 as an encoder Model Architecture
    """
    ...
    def init_network(self):
        ...
        self.encoder = MobileNet_V2(x_input=self.x_pl, num_classes=self.params.num_classes,
